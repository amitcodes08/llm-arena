    ...
    <div className="mx-auto w-full max-w-4xl px-6 py-12 sm:px-10">
      <header className="mb-14">
        ...
        <p className="text-muted-foreground mt-3 max-w-lg text-[15px] leading-relaxed">
          Prose is set in serif. Every number a machine measured is set in mono,
          at whatever size the number deserves. Rust marks the things you can
      ...
      <div className="flex flex-col gap-14">
        <Section eyebrow="Colour" title="One warm family, one accent">
          ...
          <p className="text-muted-foreground mt-4 text-sm leading-relaxed">
            Rust sits 0.45 lighter than the page and carries eleven times the
            chroma of any surface, which is what stops a button from sinking
            into the brown behind it.
          </p>
        </Section>
        ...
        <Section eyebrow="Type" title="Serif for words, mono for measurements">
          <div className="flex flex-col gap-5">
            ...
            <p className="max-w-xl text-[15px] leading-relaxed">
              Body copy is Geist, quiet on purpose. It is the delivery vehicle,
              not the personality, and it has to stay readable through a long
              streamed answer.
            </p>
        ...
        <Section eyebrow="Controls" title="Every state, including focus">
          ...
          <p className="text-muted-foreground mt-4 text-sm" id="focus">
            Tab through these. The ring is rust, two pixels, offset from the
            control, and it appears on every one of them in both themes.
          </p>
        </Section>
        ...
        <Section eyebrow="Arena" title="A response, mid-stream">
          <div className="surface overflow-hidden">
            ...
            <p className="px-4 py-4 text-[15px] leading-relaxed">
              A streamed answer lands here. There is no shimmer over the top of
              it, because the text arriving is already the thing worth watching.
            </p>
          ...
          <p className="text-muted-foreground mt-4 text-sm leading-relaxed">
            Cost reads $0.0000 because every model here is free, and that is the
            measured number, not a placeholder. It stays on screen for the same
            reason the rest do.
          </p>
        </Section>
        ...
        <Section eyebrow="Failure" title="A plain sentence and a way out">
          <div className="border-destructive/40 bg-destructive/8 rounded-xl border px-4 py-3.5">
            ...
            <p className="text-muted-foreground mt-1.5 text-sm leading-relaxed">
              The other two are still going. Try this one again, or vote on what
              you have.
            </p>
            <button
              type="button"
          ...
          <p className="text-muted-foreground mt-4 text-sm leading-relaxed">
            Rust and this red measure 1.14:1 against each other, so they are
            told apart by hue alone. That is why the error carries an icon and a
            sentence, and the winner above carries the word
            &ldquo;Winner&rdquo;. Colour is never the only signal here.
          </p>
        </Section>
      </div>
    </div>
